package IO.Test08.OutputStreamWriter08;
...
public class OutputStreamWriterTest {
    ...
    private static void write_utf_8() throws IOException {
        //1.创建OutputStreamWriter对象，构造方法中传递字节输出流和指定的编码表名称
//        OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream("src\\IO\\OutputStreamWriter08\\utf-8.txt"),"utf-8");
        OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream("src\\IO\\Test08\\utf-8.txt"));//不指定默认utf-8
    ...
    private static void write_gbk() throws IOException {
        //1.创建OutputStreamWriter对象，构造方法中传递字节输出流和指定的编码表名称
        OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream("src\\IO\\Test08\\gbk.txt"), "GBK");
